...
public class AnalyticalQuestionAdapter extends RecyclerView.Adapter <AnalyticalQuestionAdapter.ViewHolderClass>
        {
private Context mContext;
private ArrayList<GeneralCategoryModel> alistModel;

public AnalyticalQuestionAdapter(Context mContext, ArrayList<GeneralCategoryModel> alistModel)
        {
...
public ViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AnalyticalQuestionAdapter.ViewHolderClass(mView);
        }
