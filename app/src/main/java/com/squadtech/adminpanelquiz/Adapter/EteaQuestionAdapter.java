...
public class EteaQuestionAdapter extends RecyclerView.Adapter <EteaQuestionAdapter.ViewHolderClass>
{
    private Context mContext;
    private ArrayList<GeneralCategoryModel> alistModel;

    public EteaQuestionAdapter(Context mContext, ArrayList<GeneralCategoryModel> alistModel)
    {
    ...
    public ViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new EteaQuestionAdapter.ViewHolderClass(mView);
    }
